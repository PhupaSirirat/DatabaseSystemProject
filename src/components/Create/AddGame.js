...
function AddGame() {
  ...
  const handleSubmit = (event) => {
    ...
    const sql = `insert into game (gamename, description, releasedate, systems, version, genre, agerating, thumbnail_link) values ('${gamename}','${description}','${releasedate}','${systems}','${version}','${genre}','${agerating}','${thumbnail}')`;
  ...
  return (
    <main className='addgame'>
      ...
      <Link to={"/allgames"}>
        ...
        <button class="button-79">Back</button>
      </Link>
    </main>
  );
}
