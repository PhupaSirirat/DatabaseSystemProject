...
function AddGame() {
  ...
  const handleSubmit = (event) => {
    ...
    const sql = `insert into game (gamename, description, releasedate, systems, version, genre, agerating, thumbnail) values ('${gamename}','${description}','${releasedate}','${systems}','${version}','${genre}','${agerating}','${thumbnail}')`;
